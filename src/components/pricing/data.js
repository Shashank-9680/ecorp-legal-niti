...
const data2 = [
  [
    ...
    "120/month when you renew",
    [
      "DIN and DSC for two Directors Name Approval Certificate Drafting of MoA & AoA Registration fees and stamp duty Company Incorporation Certificate Company PAN and TAN Zero Balance Current Account",
    ],
  ],
  [
    ...
    "120/month when you renew",
    [
      "DSC for one director and DIN for up to three directors Drafting of MoA &amp; AoA Registration fees and stamp duty Company Incorporation Certificate",
    ],
  ],
  [
    "One Person Company",
    ...
    "120/month when you renew",
    [
      "DIN and DSC for the Director Guidance for choosing the company name Name Approval Certificate Company PAN and TAN Drafting of MoA &amp; AoA Registration fees and stamp duty Company Incorporation Certificate Zero Balance Current Account ",
    ],
  ],
  [
    "Partnership Firm",
    ...
    "120/month when you renew",
    [
      "Guidance on setting up a partnership firm Drafting Partnership Deed Two rounds of iterations &more",
    ],
  ],
]
...
const data5 = [
  ...
  [
    "Secreterial Audit Package for Companies",
    "perfect for beginners",
    "-",
    "add to cart",
    "120/month when you renew",
...
const maindata = [data1, data2, data3, data4, data5]
