        ...
        <div className="rc-post-wrap">
          <div className="rc-post-item">
            ...
            <div className="rc-post-content">
              ...
              <h5 className="title"><Link to="/service-details">New Trends In UI/UX Design World</Link></h5>
            </div>
          </div>
          <div className="rc-post-item">
            <div className="rc-post-thumb">
            ...
            <div className="rc-post-content">
              <span className="date"><i className="far fa-calendar-alt"></i> October 27, 2023</span>
              <h5 className="title"><Link to="/service-details">That Time We Burned Players</Link></h5>
            </div>
          </div>
          <div className="rc-post-item">
            <div className="rc-post-thumb">
            ...
            <div className="rc-post-content">
              <span className="date"><i className="far fa-calendar-alt"></i> October 27, 2023</span>
              <h5 className="title"><Link to="/service-details">Morning routine boost to your mood</Link></h5>
            </div>
          </div>
        </div>
      </div>
