      ...
      <section className=" banner-padding ">
        <div className="wrapper">
          <div className="left-wing">
            <h2 className="left-wing-heading">Farmer Producer Company</h2>
            <br />
            <br />
            <list>
              <ul>
                <li>
                  Effortlessly register your Farmer Producer Company under the
...
export default Farmerproducercompany
