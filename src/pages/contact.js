          ...
          <div className="content">
            <div className="left-side">
              <div className="address details">
                ...
                <div className="text-one" style={{ color: "#fff" }}>
                  Legal-Niti workspace, PG Block 5th floor, BMS College of
                  Engineering, Bengaluru - 560085
                </div>
              </div>
              <div className="phone details">
                ...
                <div className="text-two" style={{ color: "#fff" }}>
                  9481829401
                </div>
              </div>
            ...
            <div className="right-side">
              <div className="topic-text" style={{ fontSize: "35px" }}>
                Send us a message
              </div>
              <p style={{ color: "#fff" }}>
                If you're looking for a trusted partner to help you navigate the
                complex world of taxes and corporate regulations, look no
                further than legal niti. Contact us today to learn more about
              ...
              <form action="#">
                ...
                <div className="input-box message-box">
                  <textarea
                    style={{ padding: "8px 0px 30px 15px" }}
                    type="text"
